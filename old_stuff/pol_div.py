...
def main():
    num = [np.quaternion(random.choice([0, 1]), random.choice([0, 1]), random.choice([0, 1]), random.choice([0, 1])) for i in range(11) ]
    #den = [np.quaternion(1, 1, random.randrange(10),0) for i in range(3) ]
    den = [np.quaternion(1,0,0,0), np.quaternion(1,0,0,0), np.quaternion(1,0,0,0) ]
